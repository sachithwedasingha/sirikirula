...
<main class="app-main">
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0">Pending Bookings</h3>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="booking-summary-bar" style="background:#d1ffd6;">
                                ...
                                <div class="summary-item ready-bookings">
                                    ...
                                    <span class="summary-value" id="ready_count">
                                        0
                                    </span>
                                </div>
    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" id="modalReadyBtn">
                    Ready
                </button>
            </div>
        </div>
...
<div class="modal fade" id="rentoutBookingModal">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content border-0 shadow-lg">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title">
           ...
           <div class="modal-footer flex-column">
                ...
                <div class="w-100 d-flex justify-content-end gap-2">
                    ...
                    <button type="button" class="btn btn-success" id="modalrentoutBtn">
                        Rentout
                    </button>
                </div>
...
<script>
    $(document).ready(function () {
        ...
        $('#searchbarcode').on('input',function(){
            ...
            $.get("../routes/booking/search_barcode_booking.php",{
                barcode:barcode
           },function(res){
        ...
        $(document).on('click', '.btn-rentout', function () {
            ...
            $.get("../routes/booking/view_bookingrentout.php", {
                booking_id: bookingId
            }, function (res) {
                ...
                $('#rentoutBookingModal').modal('show');
        ...
        $('#modalrentoutBtn').click(function(){
            if(currentBookingId==''){
                return;
            }
            $('#rentoutBookingModal').modal('hide');
            Swal.fire({
                title:'Rent Out Booking?',
                text:'Are you sure you want to handover this booking?',
                icon:'question',
                showCancelButton:true,
                confirmButtonText:'Yes, Rent Out'
            }).then((result)=>{
                                ...
                                if(pin.length==6){
                                    $.ajax({
                                        ...
                                        success:function(res){
                                            ...
                                            $.ajax({
                                                url:'../routes/booking/rentout_booking.php',
                                                type:'POST',
                                                data:{
                                                    booking_id:currentBookingId,
                                                    handoverby:data.id,
                                                    balance_payment:$('#balance_payment').val(),
                                                    booking_balance:$('#booking_balance').val()
                                                },
                                                success:function(res){
                                                    res=res.trim();
                                                    if(res=="01"){
                                                                ...
                                                                (
                                                                    ...
                                                                    if (result
                                                                        ...
                                                                        $.get("../routes/booking/getbooking.php",{ booking_id: currentBookingId },function(res){
                                                                            ...
                                                                            if(jdata.booking.collection_type == 'OTHER_HOLD'){
                        ...
                        if (pin.length == 6) {
                            $.ajax({
                                ...
                                success: function (res) {
                                    ...
                                    Swal.close();
                                    Swal.fire({
                                        title: 'Mark Booking As Ready?',
                                        html: 'Approved By : <b>' +data.name + '</b>',
                                        icon: 'question',
                                        showCancelButton: true,
                                        confirmButtonText: 'Ready Booking'
                                    }).then((result) => {
                                        if (result
                                            .isConfirmed) {
                                            Swal.fire({
                                            ...
                                            $.ajax({
                                                url: "../routes/booking/ready_booking.php",
                                                type: "POST",
                                                data: {
                                                    booking_id: currentBookingId,
                                                    readyby: data.id
        ...
        function loadBookings() {
            $.get("../routes/booking/pending_booking_list.php", {
        ...
        $(document).on('click','.btn-cancel',function(){
            ...
            Swal.fire({
                ...
                text:'Are you sure you want to cancel this booking? Please note that any advance payment received is non-refundable.',
                icon:'warning',
                showCancelButton:true,
                                ...
                                if(pin.length==6){
                                    $.ajax({
                                        ...
                                        success:function(res){
                                            ...
                                            Swal.close();
                                            $.ajax({
                                                url:'../routes/booking/cancel_booking.php',
                                                type:'POST',
                                                data:{
                                                    booking_id:bookingId,
                                                    cancelby:data.id
